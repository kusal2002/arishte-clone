...
<head>
  ...
  <title>Dinner Menu | Arishte</title>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .menu-intro-label em { display: block; font-style: italic; color: var(--gold); }

    .menu-intro-text {
      font-size: 15px; line-height: 1.9; color: var(--text-light); font-weight: 300;
      padding-top: 10px;
    }
    ...
    .section-divider {
      ...
      padding: 0 8%; margin: 60px 0 0;
    }
    .section-divider::before,
    .section-divider::after {
      content: ''; flex: 1; height: 1px; background: rgba(184,150,90,0.25);
    }
    .section-divider span {
      font-size: 11px; letter-spacing: 4px; text-transform: uppercase; color: var(--gold); white-space: nowrap;
    }
    ...
    .menu-section-header h2 em { font-style: italic; color: var(--mid-brown); }
    .menu-section-header p { font-size: 14px; line-height: 1.8; color: var(--text-light); max-width: 640px; font-weight: 300; }
    ...
    .infusion-card:hover img { transform: scale(1.05); }
...
.contact-details li {
    ...
    @media (max-width: 900px) {
      ...
      .infusions-grid { grid-template-columns: 1fr 1fr; }
      .footer-top { grid-template-columns: 1fr; gap: 36px; }
    }
    @media (max-width: 600px) {
      .menu-card { grid-template-columns: 1fr; }
      .menu-card-img { width: 100%; height: 200px; }
      .infusions-grid { grid-template-columns: 1fr; }
...
<body>
  ...
  <div class="page-hero" style="margin-top:72px;">
    ...
    <div class="page-hero-content">
      ...
      <h1 class="page-hero-title">Dinner <em>Menu</em></h1>
    </div>
  </div>
  ...
  <section class="menu-section">
    <div class="menu-section-header">
      ...
      <p>Traditional Sri Lankan herbal porridges, slow-crafted each morning with heritage grains and hand-picked botanicals.</p>
    </div>
    <div class="menu-grid">

      <div class="menu-card">
        <img src="https://static.wixstatic.com/media/bde431_df950dac44d74278936206bb4af2ac6c~mv2.png" alt="Kurrakkan Strength" class="menu-card-img">
      ...
      <div class="menu-card">
        <img src="https://static.wixstatic.com/media/bde431_2b4a287f6af143c5b599ebfbf3e9a857~mv2.png" alt="Diya Bath Balance" class="menu-card-img">
        <div class="menu-card-body">
          <div class="menu-card-name">Diya Bath Balance</div>
          <p class="menu-card-desc">A light and refreshing kanda made from traditional rice fermentation. Known for its cooling and hydrating properties, this gentle blend supports digestion and helps your body reset naturally.</p>
        </div>
      </div>

      <div class="menu-card">
        <img src="https://static.wixstatic.com/media/bde431_d60859b7052649fb82ece3d91be53cf1~mv2.png" alt="Karapincha Boost" class="menu-card-img">
        <div class="menu-card-body">
          <div class="menu-card-name">Karapincha Boost</div>
          <p class="menu-card-desc">An aromatic herbal porridge crafted with fresh curry leaves and coconut milk. Traditionally known to support metabolism and overall vitality.</p>
        </div>
      </div>

      <div class="menu-card">
        <img src="https://static.wixstatic.com/media/bde431_c560c5226a0f446f8b49676d4d31cf64~mv2.png" alt="Walpenela Vital" class="menu-card-img">
        <div class="menu-card-body">
          <div class="menu-card-name">Walpenela Vital</div>
          <p class="menu-card-desc">A nourishing herbal kanda made with walpenela leaves, valued in traditional Sri Lankan wellness for its immunity-supporting properties.</p>
        </div>
      </div>

      <div class="menu-card" style="grid-column: 1 / -1;">
        <img src="https://static.wixstatic.com/media/bde431_aa8124026bfd4991b3631306620b8c9a~mv2.png" alt="Hathawariya Elixir" class="menu-card-img">
        <div class="menu-card-body">
          <div class="menu-card-name">Hathawariya Elixir</div>
          <p class="menu-card-desc">A premium herbal porridge made with hathawariya, known for supporting balance and vitality. Smooth, nourishing, and deeply restorative, this kanda is ideal for recharging your body and mind.</p>
        </div>
      </div>
  ...
  <section class="infusions-section">
    ...
    <div class="infusions-grid">
      <div class="infusion-card">
        <img src="https://static.wixstatic.com/media/bde431_747417d71bac492eb9397f88f800a4b9~mv2.png" alt="Spiced Apple Glow">
        <div class="infusion-body">
          <h3>Spiced Apple Glow</h3>
          <p>A delicate infusion of apple, aromatic spices, and coriander, gently brewed to create a smooth and comforting finish. Naturally uplifting and beautifully balanced, this blend is designed to warm the body and awaken the senses.</p>
        </div>
      </div>
      <div class="infusion-card">
